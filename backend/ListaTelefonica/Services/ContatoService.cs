    ...
    public class ContatoService : IContatoService
    {
        ...
        public async Task<ContatoDTO> CriarAsync(CriarContatoDTO criarContatoDto)
        {
            try
            {
                ...
                ValidarContato(criarContatoDto.Nome, criarContatoDto.Telefone);
        ...
        public async Task<ContatoDTO?> AtualizarAsync(int id, AtualizarContatoDTO atualizarContatoDTO)
        {
            ...
            {
                // Validações de negócio
                ValidarContato(atualizarContatoDTO.Nome, atualizarContatoDTO.Telefone);
        ...
        public static void ValidarContato(string nome, string telefone)
        {
            // Validações de negócio
            if (string.IsNullOrWhiteSpace(nome))
                throw new ArgumentException("Nome é o obrigatorio");
